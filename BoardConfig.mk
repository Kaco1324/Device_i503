...
-include vendor/sprd/scx35_sp7731gea_hd/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_BOARD_NAME := scx35_sp7731gea_hd
...
BOARD_MKBOOTIMG_ARGS := --dt device/sprd/scx35_sp7731gea_hd/dt.img --kernel_offset 0x00008000 --ramdisk_offset 0x01000000 --tags_offset 0x00000100
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 6140444160
...
TARGET_RECOVERY_FSTAB := $(LOCAL_PATH)/partition/fstab.sc8830
